#This script was used to obtain log2fold changes from the GSE115905 txt file 
#Emily Wood
#18th of March 2021
...
#remove duplicate samples in Gm4955, removed lower fold value for each duplicate sample
...
#convert NAs (non-significant values) to 0
Log2FCWTvsMut[is.na(Log2FCWTvsMut)] <- 0
